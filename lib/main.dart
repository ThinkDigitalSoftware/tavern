    ...
    return DynamicTheme(
      ...
      themedWidgetBuilder: (context, theme) {
        return OrientationBuilder(builder: (context, orientation) {
          return Provider<Orientation>.value(
            value: orientation,
            child: MaterialApp(
              theme: theme,
              title: "Tavern",
